    ...
    <section className='max-w-[1400px] m-auto flex flex-col gap-4 px-4 text-neutral-800 mt-[1rem] mb-[4rem]'>
        <div className='w-full flex items-center max-lg:flex-col'>
            <div className='flex flex-col gap-4 p-4 w-1/2 max-lg:w-full'>
                <h3 className='text-[3rem] font-bold max-sm:text-3xl'>Feel free to reach out</h3>
            ...
            <div className='w-1/2 flex gap-4 flex-col items-center max-lg:w-full max-lg:items-start'>
                <img className='w-[30rem] h-[20rem] shadow-customeThree rounded-lg max-lg:hidden' src="/contact.png" alt="" />
                <ContactOptions/>
            </div>
        </div>
    </section>
...
const ContactOptions = () => {
    return (
        <div className='flex  gap-6 flex-col m-[1rem] max-sm:text-sm'>
