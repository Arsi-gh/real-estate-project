...
export default function AgentsSection() {
  return (
    <div className="bg-zinc-50 p-1">
        ...
        <section className="p-8 flex gap-4 items-center justify-around max-w-[1400px] mx-auto mt-[2rem] my-[2rem]">
            <div className="h-fit bg-white pr-4 flex gap-2 rounded-lg shadow-customeThree border-[1px]">
                ...
                <span className="p-2 flex flex-col justify-center gap-2">
                    <p className="text-lg">Henry nicelson <b>MA and co founder</b></p>
                    <p>a greate reale estate agent is like a real friend </p>
                </span>
            </div>
            <div className="flex flex-wrap gap-2 justify-center items-center content-start w-1/2 h-[11rem]">
        ...
        <div className="text-lg flex items-center gap-4 justify-between px-20 max-w-[1400px] mx-auto mt-[4rem] my-[2rem]">
